...
private String flightID = "that1";

private double departTicketPrice;
...
public static String usingmath(int length) {
    String alphabetsInUpperCase = "hiwdhjd";
    String numbers = "9875479";
    ...
    public FlightBooking(String passengerFullName, LocalDate depart, LocalDate returnDate, int childPassengers, int adultPassengers) {
        this.passengerFullName = new String[3];
        this.passengerFullName[1] = passengerFullName;
        this.departureDate = depart;
        this.returnDate1 = returnDate;
    ...
    setTripSource(num);
    FlightBooking.TripSource result1 = getTripSource();
   ...
   public void setDepartureDate(LocalDate departureDate) {
    ...
    public void setReturnDate(LocalDate returnDate) {
         ...
         this.returnDate1 = departureDate.plusDays(2);
         }
        }
    ...
    public void setTicketNumber(int index) {
        String Ticketnumber;
        String k = usingmath(4);
        if(Triptype == (TripType.ONE_WAY)) {
            Ticketnumber = "11";
            if(Bookingclass == (BookingClass.FIRST)){
                Ticketnumber = Ticketnumber + "F" + k;
    ...
    public void setDepartingTicketPrice(int childPassengers, int adultPassengers) {
        ...
        if(Bookingclass == BookingClass.FIRST) {
            this.departTicketPrice = (db + 250) * (childPassengers + adultPassengers);
        } else if(Bookingclass == BookingClass.BUSINESS) {
            this.departTicketPrice = (db + 150) * (childPassengers + adultPassengers);
        } else if(Bookingclass == BookingClass.ECONOMY) {
            this.departTicketPrice = (db + 50) * (childPassengers + adultPassengers);
        }
    }
    ...
    public void setReturnTicketPrice() {
        if(Triptype == TripType.ONE_WAY) {
            ...
            this.returnTicketPrice = this.departTicketPrice;
        }
    }

    public void setTotalTicketPrice() {
        this.totalTicketPrice = this.departTicketPrice + this.returnTicketPrice;
    }
    ...
    public void content(){
        ...
        departureDate+"(Changed from old "+aDate+" to new "+returnDate1+")"+"\nAnd the return flight is on:"+ returnDate1+"\n\n");
        }
